...
input = Input(shape=[60,10,1])

x = Conv2D(nb_filter=256,nb_row=1,nb_col=10,activation='relu',name='conv1')(input)
x = MaxPooling2D(pool_size=[60,1],name='pool1')(x)
#x = Conv2D(nb_filter=128,nb_row=60,nb_col=1,activation='relu',name='conv1')(input)
